...
def main(args):
    ...
    with open(f"{args.output_dir}{args.dataset}/{model_name}/all_pred_hs_{args.prompt_mode}_nle.pkl", 'rb') as f:
        all_pred_hs = pickle.load(f)

    proj_rank1 = LowRankOrthogonalProjection.from_pretrained("jkminder/CTXPRIOR-Projection-gemma-2-9b-it-L27").to(args.device)
    proj_rank2 = LowRankOrthogonalProjection.from_pretrained("../context-vs-prior-finetuning/analysis/projections/gemma-2-9b-it-L26_epoch_1_v2").to(args.device)
    ...
    with open(f"{args.output_dir}{args.dataset}/{model_name}/all_proj_rank1_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(all_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/all_proj_rank2_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(all_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/supp_proj_rank1_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(supp_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/supp_proj_rank2_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(supp_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/ctx_conf_proj_rank1_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(ctx_conf_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/ctx_conf_proj_rank2_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(ctx_conf_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/prior_conf_proj_rank1_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(prior_conf_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/prior_conf_proj_rank2_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(prior_conf_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/comp_proj_rank1_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(comp_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/comp_proj_rank2_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(comp_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/irr_proj_rank1_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(irr_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/irr_proj_rank2_{args.prompt_mode}_nle_answer_token.pkl", 'wb') as f:
        pickle.dump(irr_proj_rank2, f)

    print(len(prior_conf_proj_rank2), len(ctx_conf_proj_rank2))
