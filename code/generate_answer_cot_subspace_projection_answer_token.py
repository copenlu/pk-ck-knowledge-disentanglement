...
def main(args):
    ...
    with open(f"{args.output_dir}{args.dataset}/{model_name}/all_pred_hs_{args.prompt_mode}_cot.pkl", 'rb') as f:
    ...
    with open(f"{args.output_dir}{args.dataset}/{model_name}/all_proj_rank1_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(all_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/all_proj_rank2_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(all_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/supp_proj_rank1_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(supp_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/supp_proj_rank2_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(supp_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/ctx_conf_proj_rank1_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(ctx_conf_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/ctx_conf_proj_rank2_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(ctx_conf_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/prior_conf_proj_rank1_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(prior_conf_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/prior_conf_proj_rank2_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(prior_conf_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/comp_proj_rank1_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(comp_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/comp_proj_rank2_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(comp_proj_rank2, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/irr_proj_rank1_{args.prompt_mode}_cot.pkl", 'wb') as f:
        pickle.dump(irr_proj_rank1, f)
    with open(f"{args.output_dir}{args.dataset}/{model_name}/irr_proj_rank2_{args.prompt_mode}_cot.pkl", 'wb') as f:
