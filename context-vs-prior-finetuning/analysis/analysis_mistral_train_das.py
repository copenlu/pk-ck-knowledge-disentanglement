...
def main(args):
    ...
    proj = train_projection(model, proj, layer=16, train_dataset=train_dataset, val_dataset=test_dataset, epochs=2, batch_size=8)

    # Save
    proj.save_pretrained("projections_v2/Mistral-7B-Instruct-v0.3-L16_epoch_1_v2")
