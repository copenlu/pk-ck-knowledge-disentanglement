...
def main(args):
    ...
    proj = LowRankOrthogonalProjection(embed_dim=3584, rank=2)

    proj = train_projection(model, proj, layer=26, train_dataset=train_dataset, val_dataset=test_dataset, epochs=2, batch_size=8)

    # Save
    proj.save_pretrained("projections_v2/gemma-2-9b-it-L26_epoch_1_v2")
